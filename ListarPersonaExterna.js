...
export default class ListarPersonaExterna extends Component {
            ...
            <div className="row">
                {
                    this.state.personaexterna.filter(x=> x.IDPersonaExterna === this.props.match.params.IDPersonaExterna).map(cor => (
                        ...
                        <Link className="btn btn-secondary" to={"/BuscarPersonaExterna"}>
                        ...
                        <div className="card-footer"> 
                                <button className="btn btn-warning" onClick={() => this.deletepersonaexterna(cor._id)}>
                            ...
                            <Link className="btn btn-success" to={"/BuscarPersonaExterna"}>
                                VOLVER
                             </Link>
                            </button>
